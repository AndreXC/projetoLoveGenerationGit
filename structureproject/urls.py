"""
URL configuration for structureproject project.
...
from .views import index, love_message_view, CreatePayment, mercado_pago_webhook, CreatePage, ViewProdutoStatus, search_produto 
